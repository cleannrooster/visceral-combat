 ...
 * from a HudRenderCallback and Forge from a RenderGuiEvent.Post, both handing over the same DrawContext.
 */
...
public class ChargeHudRenderer {
    ...
    public static void render(DrawContext context) {
        ...
        // The crosshair is a 15px icon centered on centerY; sit the bars a little below its bottom edge.
        ...
        for (int i = 0; i < count; i++) {
            ...
            // Track (full width, dim), then the recovered portion on top.
