...
public class ClientNetworkHandler {
    ...
    public static void register() {
        ...
        NetworkManager.registerReceiver(NetworkManager.Side.S2C, Packet.SwingS2C.PACKET_ID, Packet.SwingS2C.CODEC,
            (payload, context) -> context.queue(() ->
                // Someone else swung: draw the same ribbon over the same volume they see.
                SlashEffectManager.spawn(payload.attackerId(), payload.swing()))
        );
